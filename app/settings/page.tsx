  ...
  return (
    <div className="space-y-4">
      ...
      <section className="border erp-border rounded p-3 space-y-2">
        <h2 className="font-semibold">System Settings (Read-only)</h2>
        <div className="grid md:grid-cols-3 gap-3 text-sm">
          <div className="p-3 border erp-border rounded">
            <div className="opacity-70 text-xs">Timezone</div>
            <div className="font-semibold">Asia/Bangkok (UTC+7)</div>
          </div>
          <div className="p-3 border erp-border rounded">
            <div className="opacity-70 text-xs">Storage</div>
            <div className="font-semibold">UTC</div>
          </div>
          <div className="p-3 border erp-border rounded">
            <div className="opacity-70 text-xs">DST</div>
